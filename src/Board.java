...
public class Board {
    ...
    public Board(){
        ...
        properties[0][10] = new Property(new Color(0, 0, 0), "Jail", 0, 0);

        properties[1][10] = new Property(new Color(204, 68, 204), "St. Charles Place", 140, 10);
        properties[2][10] = new Property(new Color(102, 51, 0), "Electric Company", 150, 0);
        ...
        properties[5][10] = new Property(new Color(255, 255, 255), "Pennsylvania RR", 200, 25);
        properties[6][10] = new Property(new Color(204, 68, 204), "St. James Place", 180, 14);
        properties[7][10] = new Property(new Color(255, 255, 255), "Community Chest", 0, 0);
        properties[8][10] = new Property(new Color(204, 68, 204), "Tennessee Ave", 180, 14);
        properties[9][10] = new Property(new Color(204, 68, 204), "New York Ave", 200, 16);
        ...
        properties[10][0] = new Property(new Color(0, 0, 0), "Go To Jail", 0, 0);
        ...
        properties[3][0] = new Property(new Color(51, 153, 51), "Park Place", 350, 35);
        properties[2][0] = new Property(new Color(255, 255, 255), "Luxury Tax", 0, 0);
        properties[1][0] = new Property(new Color(51, 153, 51), "Board Walk", 400, 50);
    }
}
